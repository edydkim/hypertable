...
namespace Hypertable {
  ...
  public:
     ...
     * the default dispatch handler was successfully associated:
     *
     *   - <code>Error::COMM_BROKEN_CONNECTION</code>
     *   - <code>Error::OK</code>
     *
     * The default dispatch handler will be associated with the connection until
     ...
     * DISCONNECT event will be promptly delivered via the default dispatch
     * handler.  The following return codes indicate that the default dispatch
     ...
     * Upon successful completion, <code>addr</code> can be used to subsequently
     * refer to the connection.  See @ref primary_connect "connect" for
     * semantics of when <code>default_handler</code> is registered on error.
     * @param addr address to connect to
  ...
  private:
     ...
     * Error::COMM_BROKEN_CONNECTION, Error::COMM_POLL_ERROR, or
     * Error::COMM_CONNECT_ERROR on error.
     */
